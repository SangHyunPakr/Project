...
/////////////////////////////////////////////////////////////////////////////
// CIAnalogDisplayX 래퍼 클래스입니다.

class CIAnalogDisplayX : public CWnd
{
protected:
	DECLARE_DYNCREATE(CIAnalogDisplayX)
public:
...
//
	...
	STDMETHOD(get_AlignmentMargin)()
	{
		HRESULT result;
		InvokeHelper(0x2, DISPATCH_PROPERTYGET, VT_HRESULT, (void*)&result, NULL);
		return result;
	}
